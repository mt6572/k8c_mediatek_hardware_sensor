...
#if 1//def CUSTOM_KERNEL_TEMPURATURE
	#ifndef TEMPURATURE
...
#if 0//def CUSTOM_KERNEL_TEMPURATURE
	{ 
		.name       = "hp06",
		.vendor     ="hp",
		.version    = 1,
		...
		.maxRange   = 100,//600.0f,
		.resolution = 1,//0.0016667f,
		.power      = 1,
		.reserved   = {}
	}, 
#endif

#if 1//def CUSTOM_KERNEL_STEP
  { 
		.name       = "BMI160",
		.vendor     = "Bosch",
		.version    = 1,
		.handle     = ID_STEP_COUNTER,
		.type       = SENSOR_TTYPE_STEP_COUNTER ,
		.maxRange   = 1000,
		.resolution = 1,
		.power      = 1,
		.reserved   = {}
   ...
   { 
		...
		.type       = SENSOR_TTYPE_STEP_DETECTOR,
		.maxRange   = 1000,
		.resolution = 1,
		.power      = 1,
		.reserved   = {}
...
#endif
#if 0//def CUSTOM_KERNEL_HUMIDITY
  { 
		.name       = "hp06",
		.vendor     = "hp06",
		.version    = 1,
		.handle     = ID_RELATIVE_HUMIDITY,
		.type       = SENSOR_TTYPE_RELATIVE_HUMIDITY,
		.maxRange   = 1000,
		.resolution = 1,
		.power      = 1,
		.reserved   = {}
