...
LOCAL_SRC_FILES := sensors.c  hwmsen_chip_info.c nusensors.cpp InputEventReader.cpp SensorBase.cpp Hwmsen.cpp Acceleration.cpp Gyroscope.cpp Magnetic.cpp sensordebug.cpp StepCounter.cpp Pedometer.cpp
#LOCAL_SRC_FILES := sensors_hwmsen.c  hwmsen_chip_info.c StepCounter.cpp Pedometer.cpp
LOCAL_C_INCLUDES+= \
